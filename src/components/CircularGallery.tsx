...
class Media {
  ...
  scale = 0; padding = 0; width = 0; widthTotal = 0; x = 0;
...
class App {
  container: HTMLElement; scrollSpeed: number; scroll: any;
...
export default function CircularGallery({
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="region"
      aria-label="Circular collection gallery. Use left and right arrow keys to navigate."
    />
  );
}
